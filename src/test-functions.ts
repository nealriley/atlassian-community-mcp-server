...
const tests: FunctionTest[] = [
  ...
  },
  {
    ...
    fn: async () => getTopPostsByViewsForTag(
      testParams.tag, 
      testParams.limit, 
      testParams.offset
    ),
  ...
  },
  {
    ...
    fn: async () => getMostRecentPostsByTag(
      testParams.tag, 
      testParams.limit, 
      testParams.offset
    ),
...
function analyzeResponseType(response: any): string {
